...
def route():
    ...
    try:
        ...
        parsed_content, totals, totals_text = quantity_parser.parse(config.site_production_option, None, year)
        
        quantity_service.persist_parsed_content(parsed_content, totals_text, "production", year, "production")
        ...
        try:
            real_time = False
            success, parsed_content, totals, totals_text, parse_date = quantity_service.load_parsed_content("production", year, "production")
